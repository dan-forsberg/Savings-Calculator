...
var SavingsForm = /** @class */ (function (_super) {
    ...
    SavingsForm.prototype.render = function () {
        var form = React.createElement("form", { onSubmit: this.handleSubmit },
            ...
            React.createElement("input", { name: "startCapital", type: "number", min: "0", value: this.state.startCap, onChange: this.handleChange }),
            React.createElement("label", { htmlFor: "monthlySavings" }, "M\u00E5nadsparande"),
            React.createElement("input", { name: "monthlySavings", type: "number", min: "0", value: this.state.moSav, onChange: this.handleChange }),
